...
struct MANGOS_DLL_DECL npc_small_pet_handlerAI : public ScriptedAI
{
    ...
    void PetAction(uint32 uiPetGUID)
    {
        ...
        switch(uiPetGUID)
        {
            case NPC_PANDA:
            {
                DoCast(m_creature, urand(0, 1) ? SPELL_PANDA_SLEEP : SPELL_PANDA_ROAR);
                break;
            }
            case NPC_DIABLO:
            {
            ...
            case NPC_CHILLY:
            {
                ...
                m_uiActionTimer = urand(5000, 10000); // repeat
                m_bIsInAction = false;
                break;
            }
            case NPC_STINKER:
            ...
            {
                DoCast(m_creature, urand(0, 1) ? SPELL_SPRING_RABBIT_IN_LOVE : SPELL_SPRING_RABBIT_JUMP);
                break;
            }
            ...
            {
                DoCast(m_creature, urand(0, 1) ? SPELL_SPROUTLING_SLEEP : SPELL_SPROUTLING_DANCE);
                break;
            }
